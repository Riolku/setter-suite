...
- `init-template`: Creates a template. Specify the name of C++ files you want to include, and it will output (to stdout), a concatenation of those files and all of their requirements. See also the `C++ Utilities` section.
