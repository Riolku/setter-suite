use super::super::{identical_whitespace, panic_error_handler, reader};
use super::*;
...
fn test_read_maybe_array() {
    ...
    assert_eq!(
        read_maybe_array!(reader, 4, usize, 1..=4),
        Some(vec![1, 2, 3, 4])
    );
...
fn new_test_reader(
    ...
    identical_whitespace::Tokenizer<impl reader::AsciiStream + '_>,
